[Human Interface Guidelines](../../README.md) › [Components](../../Components.md) › [Layout and organization](../Layout%20and%20organization.md) › **Lists and tables**
...
**Use an outline view instead of a table view to present hierarchical data.** An [outline view](Outline%20views.md) looks like a table view, but includes disclosure triangles for exposing nested levels of data. For example, an outline view might display folders and the items they contain.
