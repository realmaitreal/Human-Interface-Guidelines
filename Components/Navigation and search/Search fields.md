[Human Interface Guidelines](../../README.md) › [Components](../../Components.md) › [Navigation and search](../Navigation%20and%20search.md) › **Search fields**
...
> **Note**
>
> Updated terminology and refined guidance for search as a tab in iOS.

![A stylized representation of a search field containing placeholder text and a dictation icon. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/components-search-field-intro@2x.png)
...
For developer guidance, see [Adding a search interface to your app](https://developer.apple.com/documentation/swiftui/adding-a-search-interface-to-your-app); for guidance related to systemwide search, see [Searching](../../Patterns/Searching.md).
...
![A diagram of the Mail app on iPhone with the search field open above the keyboard and the word Design entered in the field. Callouts indicate a scope bar at the top of the screen to switch between searching all mailboxes and the current mailbox, and a list of tokens in a Suggestions area beneath the bar that represent different filters for the search.](https://developer.apple.com/tutorials/images/com.apple.HIG/search-fields-scope-control-tokens@2x.png)
...
**Use tokens to filter by common search terms or items.** When you define a token, the term it represents gains a visual treatment that encapsulates it, indicating that people can select and edit it as a single item. Tokens can clarify a search term, like filtering by a specific contact in Mail, or focus a search to a specific set of attributes, like filtering by photos in Messages. For the related macOS component, see [Token fields](Token%20fields.md).
...
![An illustration of an iPad screen with a search field at the top of the sidebar on the leading edge of the screen.](https://developer.apple.com/tutorials/images/com.apple.HIG/search-fields-ipad-search-in-sidebar@2x.png)
...
![An illustration of an iPad screen with a tab bar at the top edge. The trailing side of the tab bar includes a Search tab with a distinct background color to differentiate it from other tab areas.](https://developer.apple.com/tutorials/images/com.apple.HIG/search-fields-ipad-search-in-tab-bar@2x.png)
...
![An illustration of a search screen in tvOS. The screen includes a field with a keyboard input area at the top, a scope bar, and a grid of top results at the bottom.](https://developer.apple.com/tutorials/images/com.apple.HIG/search-fields-tvos-search@2x.png)
...
[Token fields](Token%20fields.md)
...
- <a href="https://developer.apple.com/videos/play/wwdc2026/292"><img src="https://devimages-cdn.apple.com/wwdc-services/images/9B2E82C5-4DDF-4B9A-9459-328D8E297696/5614F523-C21B-4ADC-AF14-0417BC34EA15/10836_wide_250x141_2x.jpg" alt="5614f523 c21b 4adc af14 0417bc34ea15" width="64"></a> [Design intuitive search experiences](https://developer.apple.com/videos/play/wwdc2026/292) — Explore new patterns and best practices when implementing search in your app. Discover how search plays a key role in helping people find and navigate content, and find out how to integrate search across different navigation models and Apple platforms.
