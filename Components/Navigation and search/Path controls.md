[Human Interface Guidelines](../../README.md) › [Components](../../Components.md) › [Navigation and search](../Navigation%20and%20search.md) › **Path controls**
...
![A screenshot of a Finder path bar that displays a hierarchy of four locations.](/images/com.apple.HIG/path-controls-standard@2x.png)
...
![A screenshot of a path control showing a folder icon and a pop-up control.](/images/com.apple.HIG/path-controls-popup@2x.png)
