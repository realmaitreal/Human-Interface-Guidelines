...
![An illustration of the Steps chart in the Health app, which shows the average number of steps per day for a single week.](/images/com.apple.HIG/charts-dynamic-range-axis-small@2x.png)  
*Weekly range*

![An illustration of the Steps chart in the Health app, which shows the average number of steps per day in a one-month period.](/images/com.apple.HIG/charts-dynamic-range-axis-large@2x.png)  
*Monthly range*
