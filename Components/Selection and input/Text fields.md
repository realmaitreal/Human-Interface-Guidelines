[Human Interface Guidelines](../../README.md) › [Components](../../Components.md) › [Selection and input](../Selection%20and%20input.md) › **Text fields**
...
**Use a text field to request a small amount of information, such as a name or an email address.** To let people input larger amounts of text, use a [Text views](../Content/Text%20views.md) instead.
...
**Consider using a combo box if you need to pair text input with a list of choices.** For related guidance, see [Combo boxes](Combo%20boxes.md).
