[Human Interface Guidelines](../../README.md) › [Components](../../Components.md) › [Menus and actions](../Menus%20and%20actions.md) › **The menu bar**
...
![A stylized representation of the macOS menu bar displaying a selected menu. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/components-the-menu-bar-intro@2x.png)
...
![An illustration of an app window on iPad, with its menu bar appearing at the top of the screen and the Edit menu open.](https://developer.apple.com/tutorials/images/com.apple.HIG/menu-bar-ipad-overview@2x.png)
...
| Settings… | Opens your [Settings](../../Patterns/Settings.md) window, or your app’s page in iPadOS Settings. | Use only for app-level settings. If you also offer document-specific settings, put them in the File menu. |
...
| Menu item | Action |
| --- | --- |
| Show/Hide Tab Bar | Toggles the visibility of the [Tab bars](../Navigation%20and%20search/Tab%20bars.md) above the body area in a tab-based window |
...
| Show/Hide Sidebar | In a window that includes a [Sidebars](../Navigation%20and%20search/Sidebars.md), toggles the sidebar’s visibility |
| Enter/Exit Full Screen | In an app that supports a [Going full screen](../../Patterns/Going%20full%20screen.md), opens the window at full-screen size in a new space |
...
| Enter/Exit Full Screen | In an app that supports a [Going full screen](../../Patterns/Going%20full%20screen.md), opens the window at full-screen size in a new space. | Include this item in the Window menu only if your app doesn’t have a View menu. In this scenario, continue to provide separate Minimize and Zoom menu items. |
...
When people enter full-screen mode, the menu bar typically hides until they reveal it by moving the pointer to the top of the screen. For guidance, see [Going full screen](../../Patterns/Going%20full%20screen.md).
...
![A screenshot of the Input menu bar extra and its menu.](https://developer.apple.com/tutorials/images/com.apple.HIG/menu-bar-extras@2x.png)
...
**Display a menu — not a popover — when people click your menu bar extra.** Unless the app functionality you want to expose is too complex for a menu, avoid presenting it in a [Popovers](../Presentation/Popovers.md).
...
**Consider exposing app-specific functionality in other ways, too.** For example, you can provide a [Dock menu](Dock%20menus.md) that appears when people Control-click your app’s Dock icon. People can hide or choose not to use your menu bar extra, but a Dock menu is aways available when your app is running.
