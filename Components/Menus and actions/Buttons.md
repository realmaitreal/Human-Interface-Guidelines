[Human Interface Guidelines](../../README.md) › [Components](../../Components.md) › [Menus and actions](../Menus%20and%20actions.md) › **Buttons**
...
There are also many button-like components that have distinct appearances and behaviors for specific use cases, like [Toggles](../Selection%20and%20input/Toggles.md), [Pop-up buttons](Pop-up%20buttons.md), and [Segmented controls](../Selection%20and%20input/Segmented%20controls.md).
...
**Prefer using a symbol in a square button.** [SF Symbols](../../Foundations/SF%20Symbols.md) provides a wide range of symbols that automatically receive appropriate coloring in their default state and in response to user interaction.
...
Help buttons are circular, consistently sized buttons that contain a question mark. For guidance on creating help documentation, see [Offering help](../../Patterns/Offering%20help.md).
...
**If you need to include a label, position it below the image button.** For related guidance, see [Labels](../Layout%20and%20organization/Labels.md).
