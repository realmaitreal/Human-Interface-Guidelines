...
![A partial screenshot of controls in Control Center, such as the Airplane Mode toggle, Wi-Fi toggle, and AirPlay button. The image is tinted red to subtly reflect the red in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/components-controls-intro@2x.png)
...
![A diagram showing the placement of the symbol image, the title, and the value for a control toggle.](https://developer.apple.com/tutorials/images/com.apple.HIG/control-medium-anatomy@2x.png)
...
![A representation of a control with the ability to set an option to a value a person chooses.](https://developer.apple.com/tutorials/images/com.apple.HIG/control-configuration-options@2x.png)
