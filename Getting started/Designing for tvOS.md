[Human Interface Guidelines](../README.md) › [Getting started](../Getting%20started.md) › **Designing for tvOS**
...
![A stylized representation of a TV screen shown on top of a grid. The image is overlaid with rectangular and circular grid lines and is tinted green to subtly reflect the green in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/platforms-tvOS-intro@2x.png)
...
**Inputs.** People can use a [remote](../Inputs/Remotes.md), a [game controller](../Inputs/Game%20controls.md), their [voice](../Technologies/Siri.md), and apps running on their other devices to interact with Apple TV.
