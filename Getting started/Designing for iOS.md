[Human Interface Guidelines](../README.md) › [Getting started](../Getting%20started.md) › **Designing for iOS**
...
![A stylized representation of an iPhone frame shown on top of a grid. The image is overlaid with rectangular and circular grid lines and is tinted green to subtly reflect the green in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/platforms-iOS-intro@2x.png)
...
**Inputs.** Multi-Touch [gestures](../Inputs/Gestures.md), [virtual keyboards](../Components/Selection%20and%20input/Virtual%20keyboards.md), and [voice](../Technologies/Siri.md) control let people perform actions and accomplish meaningful tasks while they’re on the go. In addition, people often want apps to use their [personal data](../Foundations/Privacy.md) and input from the device’s [gyroscope and accelerometer](../Inputs/Gyroscope%20and%20accelerometer.md), and they may also want to participate in [spatial interactions](https://developer.apple.com/design/human-interface-guidelines/spatial-interactions).
