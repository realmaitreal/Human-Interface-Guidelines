[Human Interface Guidelines](../README.md) › [Getting started](../Getting%20started.md) › **Designing for macOS**
...
**Inputs.** People expect to enter data and control the interface using any combination of input modes, such as physical [Keyboards](../Inputs/Keyboards.md), [Pointing devices](../Inputs/Pointing%20devices.md), [Game controls](../Inputs/Game%20controls.md), and [Siri](../Technologies/Siri.md).
...
- <a href="https://developer.apple.com/videos/play/wwdc2025/310"><img src="https://devimages-cdn.apple.com/wwdc-services/images/3055294D-836B-4513-B7B0-0BC5666246B0/754D8BF7-206F-4342-8705-7B836D449D9C/10015_wide_250x141_2x.jpg" alt="754d8bf7 206f 4342 8705 7b836d449d9c" width="64"></a> [Build an AppKit app with the new design](https://developer.apple.com/videos/play/wwdc2025/310) — Update your AppKit app to take full advantage of the new design system. We’ll dive into key changes to tab views, split views, bars, presentations, search, and controls, and show you how to use Liquid Glass in your custom UI. To get the most out of this video, we recommend first watching “Get to know the new design system” for general design guidance.
