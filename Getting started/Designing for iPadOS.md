[Human Interface Guidelines](../README.md) › [Getting started](../Getting%20started.md) › **Designing for iPadOS**
...
**Inputs.** People can interact with iPad using Multi-Touch [gestures](../Inputs/Gestures.md) and [virtual keyboards](../Components/Selection%20and%20input/Virtual%20keyboards.md), an attached [keyboard](../Inputs/Keyboards.md) or [pointing device](../Inputs/Pointing%20devices.md), [Apple Pencil](../Inputs/Apple%20Pencil%20and%20Scribble.md), or [voice](../Technologies/Siri.md), and they often combine multiple input modes.
