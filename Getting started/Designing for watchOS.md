[Human Interface Guidelines](../README.md) › [Getting started](../Getting%20started.md) › **Designing for watchOS**
...
![A stylized representation of an Apple Watch frame shown on top of a grid. The image is overlaid with rectangular and circular grid lines and is tinted green to subtly reflect the green in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/platforms-watchOS-intro@2x.png)
...
**Inputs.** People can navigate vertically or inspect data by turning the [Digital Crown](../Inputs/Digital%20Crown.md), which offers consistent control on the watch face, the Home Screen, and within apps. They can provide input even while they’re in motion with standard [gestures](../Inputs/Gestures.md) like tap, swipe, and drag. Pressing the [Action button](../Inputs/Action%20button.md) initiates an essential action without looking at the screen, and using [shortcuts](https://developer.apple.com/design/human-interface-guidelines/siri#Shortcuts-and-suggestions) helps people perform their routine tasks quickly and easily. People can also take advantage of data that device features provide, such as GPS, sensors for blood oxygen and heart function, and the altimeter, accelerometer, and gyroscope.
...
- Minimize the depth of hierarchy in your app’s navigation, and use the [Digital Crown](../Inputs/Digital%20Crown.md) to provide vertical navigation for scrolling or switching between screens.
...
- Use [complications](../Components/System%20experiences/Complications.md) to provide relevant, potentially dynamic data and graphics right on the watch face where people can view them on every wrist raise and tap them to dive straight into your app.
- Use [notifications](../Components/System%20experiences/Notifications.md) to deliver timely, high-value information and let people perform important actions without opening your app.
- Use background content such as [color](../Foundations/Color.md) to convey useful supporting information, and use  [materials](../Foundations/Materials.md) to illustrate hierarchy and a sense of place.
...
<a href="https://developer.apple.com/videos/play/wwdc2025/334"><img src="https://devimages-cdn.apple.com/wwdc-services/images/3055294D-836B-4513-B7B0-0BC5666246B0/29B2363D-8DFB-4A25-A3DB-A804582858FD/9956_wide_250x141_2x.jpg" alt="29b2363d 8dfb 4a25 a3db a804582858fd" width="100%"></a>  
