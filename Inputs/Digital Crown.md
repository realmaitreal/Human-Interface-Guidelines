[Human Interface Guidelines](../README.md) › [Inputs](../Inputs.md) › **Digital Crown**
...
- Adjust volume
- Adjust the amount of immersion in a portal, an Environment, or an app or game running in a Full Space (for guidance, see [Immersive experiences](../Foundations/Immersive%20experiences.md))
...
[Action button](Action%20button.md)
