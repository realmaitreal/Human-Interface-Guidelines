[Human Interface Guidelines](../README.md) › [Patterns](../Patterns.md) › **Searching**
...
**If search is important, give it a primary position in your app or view.** For example, in the Notes app, a search field is in the bottom [Toolbars](../Components/Menus%20and%20actions/Toolbars.md) alongside other important actions. In apps that use [Tab bars](../Components/Navigation%20and%20search/Tab%20bars.md), like Photos and Apple TV, search is a dedicated tab.
...
**Prefer using the system-provided open and save views.** The system-provided open and save views generally include a built-in search field that people can use to search and filter the entire system. For related guidance, see [File management](File%20management.md).
