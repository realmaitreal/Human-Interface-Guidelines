[Human Interface Guidelines](../README.md) › [Technologies](../Technologies.md) › **Mac Catalyst**
...
To learn more about the characteristics that distinguish the Mac experience, see [Designing for macOS](../Getting%20started/Designing%20for%20macOS.md). For developer guidance, see [Mac Catalyst](https://developer.apple.com/documentation/uikit/mac-catalyst).
...
- [Split views](../Components/Layout%20and%20organization/Split%20views.md). A split view supports hierarchical navigation, which consists of a two- or three-column interface that shows a primary column, an optional supplementary column, and a secondary pane of content. Frequently, apps use the primary column to create a sidebar-based interface where changes in the sidebar drive changes in the optional supplementary column, which then affect the content in the content pane.
- [Tab bars](../Components/Navigation%20and%20search/Tab%20bars.md). A tab bar supports flat navigation by displaying top-level categories in a persistent bar at the bottom of the screen.
- [Page controls](../Components/Presentation/Page%20controls.md). A page control displays dots at the bottom of the screen that indicate the position of the current page in a flat list of pages.
...
If you provide [pop-up buttons](../Components/Menus%20and%20actions/Pop-up%20buttons.md) or [pull-down buttons](../Components/Menus%20and%20actions/Pull-down%20buttons.md) that reveal a menu in your iPad app, the menu automatically takes on a macOS appearance in the Mac app you create with Mac Catalyst.
...
<a href="https://developer.apple.com/videos/play/wwdc2019/809"><img src="https://devimages-cdn.apple.com/wwdc-services/images/48/C0F7535C-FB17-48D8-8530-F959A9471DCE/3273_wide_250x141_2x.jpg" alt="c0f7535c fb17 48d8 8530 f959a9471dce" width="100%"></a>  
