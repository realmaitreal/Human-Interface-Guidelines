...
![An illustration showing a cube and a hand with the index finger touching the cube. There's a curved line intersecting the finger and cube to indicate the movement of the finger to the right as it directly manipulates the object.](/images/com.apple.HIG/augmented-reality-user-interaction-direct@2x.png)  
*Direct manipulation*

![An illustration showing a cube. Below the cube are two buttons, each with a circular arrow pointing in the opposite direction, offering indirect ways to rotate the cube.](/images/com.apple.HIG/augmented-reality-user-interaction-indirect@2x.png)  
*Indirect controls*
...
![An illustration of a cube. The base of the cube is indicated with a grid, and the active side of the cube is outlined in blue. Arrows follow a continuous circle around the cube to the right, hinting that the cube can be rotated within the 3D context.](/images/com.apple.HIG/augmented-reality-3d-hint@2x.png)  
*Prefer a 3D hint in a 3D context.*

![An illustration of a cube. The base of the cube is indicated with a grid, and underneath the cube is the word Rotate, hinting that the cube can be rotated within the 3D space.](/images/com.apple.HIG/augmented-reality-2d-hint@2x.png)  
...
![The AR glyph.](/images/com.apple.HIG/augmented-reality-glyph@2x.png)

![A button containing the AR glyph and the text View in AR.](/images/com.apple.HIG/augmented-reality-glyph-button@2x.png)
...
![The AR badge with both the glyph and the text AR.](/images/com.apple.HIG/augmented-reality-badge-iconandtext@2x.png)  
*AR badge*

![The glyph-only AR badge.](/images/com.apple.HIG/augmented-reality-badge-icon@2x.png)  
*Glyph-only AR badge*
...
![An illustration of the AR badge with the AR glyph and text AR. A frame surrounds the badge to indicate leaving clear space around the badge.](/images/com.apple.HIG/augmented-reality-badge-iconandtext-clear@2x.png)

![An illustration of the glyph-only AR badge. A frame surrounds the badge to indicate leaving clear space around the badge.](/images/com.apple.HIG/augmented-reality-badge-icon-clear@2x.png)
