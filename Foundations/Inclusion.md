[Human Interface Guidelines](../README.md) › [Foundations](../Foundations.md) › **Inclusion**
...
![A sketch of two people, suggesting inclusion. The image is overlaid with rectangular and circular grid lines and is tinted yellow to subtly reflect the yellow in the original six-color Apple logo.](https://developer.apple.com/tutorials/images/com.apple.HIG/foundations-inclusion-intro@2x.png)
...
- Present a clear, straightforward interface. To help you design a simple interface that fits in with other experiences on each platform, see [Designing for iOS](../Getting%20started/Designing%20for%20iOS.md), [Designing for iPadOS](../Getting%20started/Designing%20for%20iPadOS.md), [Designing for macOS](../Getting%20started/Designing%20for%20macOS.md),  [Designing for tvOS](../Getting%20started/Designing%20for%20tvOS.md), [Designing for visionOS](../Getting%20started/Designing%20for%20visionOS.md), [Designing for watchOS](../Getting%20started/Designing%20for%20watchOS.md), and [Designing for games](../Getting%20started/Designing%20for%20games.md).
- Build in ways to learn how to use your app or game. Consider designing an onboarding flow that helps people who are new to your experience take a step-by-step approach while letting others skip straight to the content they want. For guidance, see [Onboarding](../Patterns/Onboarding.md).
