...
| --- | --- | --- |
| Cut | ![An icon showing a pair of scissors.](/images/com.apple.HIG/icons-symbols-meaning-cut@2x.png) | `scissors` |
| Copy | ![An icon showing two copies of a document.](/images/com.apple.HIG/icons-symbols-meaning-copy@2x.png) | `document.on.document` |
| Paste | ![An icon showing a document in front of a clipboard.](/images/com.apple.HIG/icons-symbols-meaning-paste@2x.png) | `document.on.clipboard` |
| Done | ![An icon showing a checkmark.](/images/com.apple.HIG/icons-symbols-meaning-done-save@2x.png) | `checkmark ` |
| Save |  |  |
| Cancel | ![An icon showing an X.](/images/com.apple.HIG/icons-symbols-meaning-close-cancel@2x.png) | `xmark` |
| Close |  |  |
| Delete | ![An icon showing a trash can.](/images/com.apple.HIG/icons-symbols-meaning-delete@2x.png) | `trash` |
| Undo | ![An icon showing an arrow curving toward the top left.](/images/com.apple.HIG/icons-symbols-meaning-undo@2x.png) | `arrow.uturn.backward` |
| Redo | ![An icon showing an arrow curving toward the top right.](/images/com.apple.HIG/icons-symbols-meaning-redo@2x.png) | `arrow.uturn.forward` |
| Compose | ![An icon showing a pencil positioned over a square.](/images/com.apple.HIG/icons-symbols-meaning-compose@2x.png) | `square.and.pencil` |
| Duplicate | ![An icon showing a square with a plus sign on top of another square.](/images/com.apple.HIG/icons-symbols-meaning-duplicate@2x.png) | `plus.square.on.square` |
| Rename | ![An icon showing a pencil.](/images/com.apple.HIG/icons-symbols-meaning-rename@2x.png) | `pencil` |
| Move to | ![An icon showing a folder.](/images/com.apple.HIG/icons-symbols-meaning-move-to-folder@2x.png) | `folder` |
| Folder |  |  |
| Attach | ![An icon showing a paperclip.](/images/com.apple.HIG/icons-symbols-meaning-attach@2x.png) | `paperclip` |
| Add | ![An icon showing a plus sign.](/images/com.apple.HIG/icons-symbols-meaning-add@2x.png) | `plus` |
| More | ![An icon showing an ellipsis.](/images/com.apple.HIG/icons-symbols-meaning-more@2x.png) | `ellipsis` |

### Selection

| Action | Icon | Symbol name |
| --- | --- | --- |
| Select | ![An icon showing a checkmark in a circle.](/images/com.apple.HIG/icons-symbols-meaning-select-all@2x.png) | `checkmark.circle` |
| Deselect | ![An icon showing an X.](/images/com.apple.HIG/icons-symbols-meaning-deselect-close@2x.png) | `xmark` |
| Close |  |  |
| Delete | ![An icon showing a trash can.](/images/com.apple.HIG/icons-symbols-meaning-delete@2x.png) | `trash` |
...
| Action | Icon | Symbol name |
| --- | --- | --- |
| Superscript | ![An icon showing the capital letter A with the number 1 in the upper right corner.](/images/com.apple.HIG/icons-symbols-meaning-superscript@2x.png) | `textformat.superscript` |
| Subscript | ![An icon showing the capital letter A with the number 1 in the lower right corner.](/images/com.apple.HIG/icons-symbols-meaning-subscript@2x.png) | `textformat.subscript` |
| Bold | ![An icon showing the capital letter B in bold.](/images/com.apple.HIG/icons-symbols-meaning-bold@2x.png) | `bold` |
| Italic | ![An icon showing the capital letter I in italics.](/images/com.apple.HIG/icons-symbols-meaning-italic@2x.png) | `italic` |
| Underline | ![An icon showing the capital letter U with an underline.](/images/com.apple.HIG/icons-symbols-meaning-underline@2x.png) | `underline` |
| ​​Align Left | ![An icon showing a stack of four horizontal lines of varying widths that align at the left edge.](/images/com.apple.HIG/icons-symbols-meaning-align-left@2x.png) | `text.alignleft` |
| Center | ![An icon showing a stack of four horizontal lines of varying widths that align in the center.](/images/com.apple.HIG/icons-symbols-meaning-align-center@2x.png) | `text.aligncenter` |
| Justified | ![An icon showing a stack of four horizontal lines of identical widths.](/images/com.apple.HIG/icons-symbols-meaning-align-justified@2x.png) | `text.justify` |
| Align Right | ![An icon showing a stack of four horizontal lines of varying widths that align at the right edge.](/images/com.apple.HIG/icons-symbols-meaning-align-right@2x.png) | `text.alignright` |

### Search

| Action | Icon | Symbol name |
| --- | --- | --- |
| Search | ![An icon showing a magnifying glass.](/images/com.apple.HIG/icons-symbols-meaning-search@2x.png) | `magnifyingglass` |
| Find | ![An icon showing a magnifying glass above a document.](/images/com.apple.HIG/icons-symbols-meaning-find@2x.png) | `text.page.badge.magnifyingglass` |
| Find and Replace |  |  |
| Find Next |  |  |
| Find Previous |  |  |
| Use Selection for Find |  |  |
| Filter | ![An icon showing a stack of three horizontal lines decreasing in width from top to bottom.](/images/com.apple.HIG/icons-symbols-meaning-filter@2x.png) | `line.3.horizontal.decrease` |

### Sharing and exporting

| Action | Icon | Symbol name |
| --- | --- | --- |
| Share | ![An icon showing an arrow pointing up from the middle of square.](/images/com.apple.HIG/icons-symbols-meaning-sharing@2x.png) | `square.and.arrow.up` |
| Export |  |  |
| Print | ![An icon showing a printer.](/images/com.apple.HIG/icons-symbols-meaning-print@2x.png) | `printer` |

### Users and accounts

| Action | Icon | Symbol name |
| --- | --- | --- |
| Account | ![An icon showing an abstract representation of a person’s head and shoulders in a circular outline.](/images/com.apple.HIG/icons-symbols-meaning-account-user@2x.png) | `person.crop.circle` |
| User |  |  |
| Profile |  |  |
...
| Action | Icon | Symbol name |
| --- | --- | --- |
| Dislike | ![An icon showing a hand giving a thumbs down gesture.](/images/com.apple.HIG/icons-symbols-meaning-dislike@2x.png) | `hand.thumbsdown` |
| Like | ![An icon showing a hand giving a thumbs up gesture.](/images/com.apple.HIG/icons-symbols-meaning-like@2x.png) | `hand.thumbsup` |

### Layer ordering

| Action | Icon | Symbol name |
| --- | --- | --- |
| Bring to Front | ![An icon showing a stack of three squares overlapping each other, with the top square using a solid fill style while the other squares are outlines.](/images/com.apple.HIG/icons-symbols-meaning-bring-to-front@2x.png) | `square.3.layers.3d.top.filled` |
| Send to Back | ![An icon showing a stack of three squares overlapping each other, with the bottom square using a solid fill style while the other squares are outlines.](/images/com.apple.HIG/icons-symbols-meaning-send-to-back@2x.png) | `square.3.layers.3d.bottom.filled` |
| Bring Forward | ![An icon showing a stack of two squares overlapping each other, with the top square using a solid fill style while the other square is an outline.](/images/com.apple.HIG/icons-symbols-meaning-bring-forward@2x.png) | `square.2.layers.3d.top.filled` |
| Send Backward | ![An icon showing a stack of two squares overlapping each other, with the bottom square using a solid fill style while the other square is an outline.](/images/com.apple.HIG/icons-symbols-meaning-send-backwards@2x.png) | `square.2.layers.3d.bottom.filled` |

### Other

| Action | Icon | Symbol name |
| --- | --- | --- |
| Alarm | ![An icon showing an alarm clock.](/images/com.apple.HIG/icons-symbols-meaning-alarm@2x.png) | `alarm` |
| Archive | ![An icon showing a file box.](/images/com.apple.HIG/icons-symbols-meaning-archive@2x.png) | `archivebox` |
| Calendar | ![An icon showing a calendar.](/images/com.apple.HIG/icons-symbols-meaning-calendar@2x.png) | `calendar` |
