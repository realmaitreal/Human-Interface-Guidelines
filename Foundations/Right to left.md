...
![An image showing two paragraphs of placeholder copy. The first paragraph is in Arabic and the second paragraph is in English. Both paragraphs are right-aligned.](/images/com.apple.HIG/paragraph-alignment-wrong@2x.png)  
...
![From the right, the numerals one, two, and three in Eastern Arabic numerals.](/images/com.apple.HIG/textformat-123-ar@2x.png)  
...
![From the left, the two words order and number followed by the number 123456 in Latin script.](/images/com.apple.HIG/latin-numerals@2x.png)  
*Latin*

![From the right, the two words order and number followed by the number 12345 in Hebrew script.](/images/com.apple.HIG/hebrew-numerals@2x.png)  
*Hebrew*

![From the right, the two words order and number in Arabic script, followed by the number 12345 in Western Arabic numerals.](/images/com.apple.HIG/western-arabic-numerals@2x.png)  
...
![A simplified illustration of a globe that shows a horizontally flipped Eastern hemisphere with Africa on the far right and Australia on the far left.](/images/com.apple.HIG/image-displayed-wrong@2x.png)
...
![A rounded rectangle that contains three horizontal right-aligned lines.](/images/com.apple.HIG/doc-plaintext-rtl@2x.png)  
...
![A black disk with two white lines in the nine o'clock position.](/images/com.apple.HIG/clock-fill-ltr@2x.png)
...
![A silhouette of a wheeled shopping cart that faces left. A white plus sign inside a black disk is in the top-left corner.](/images/com.apple.HIG/cart-fill-badge-plus-rtl@2x.png)
...
![A rounded rectangle that contains a black dot in the top-left corner. The outline of a magnifying glass that contains a stack of two rightt-aligned lines is on top of the rectangle and to the right of the dot, slanted at about 135 degrees.](/images/com.apple.HIG/mail-and-text-magnifyingglass-rtl@2x.png)  
